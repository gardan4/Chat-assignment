...
Squad Nous is an AI-powered chatbot for car insurance quote registration . It collects customer data through natural conversation using LLM-driven extraction. The system is **schema-driven**: changing `config/prompt.yaml` changes the conversation flow, extracted fields, database structure, and frontend UI without code changes.
