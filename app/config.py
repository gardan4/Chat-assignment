...
class PromptConfig:
    ...
    def reload(self):
        ...
        self._schema_version = hashlib.sha256(self._system_prompt.encode("utf-8")).hexdigest()[:12]
    ...
    def description(self) -> str:
        default = (
            "I'll collect a few details and then our team will "
            "prepare a personalized quote for you."
        )
        return self._raw.get("description", default)
